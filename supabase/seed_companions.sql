...
-- Seed Data for Companions (35 Total)
...
VALUES
  ('c1', 'Lucas', 'Male', 'Anxiety & Panic', 'AVAILABLE', 4.9, 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=800', 'Specializing in grounding techniques and immediate panic reduction.', 'r5f0577fc829', 'LCSW-NY-44021', 'MSW, Columbia University', 'NY', 8),
  ('c2', 'Celine', 'Female', 'Life Coaching', 'AVAILABLE', 4.8, 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=800', 'Success roadmap planning and career strategy.', 'r1a0108fbd75', 'ICF-PCC-9921', 'MBA, Stanford', 'CA', 12),
  ('c3', 'Gloria', 'Female', 'Elder Care', 'AVAILABLE', 5.0, 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&q=80&w=800', 'Support for caregivers.', 'r5dc7c7d0bcb', 'BSW-FL-3321', 'BSW, Gerontology', 'FL', 20),
  ('c4', 'Anna', 'Female', 'Family Dynamics', 'AVAILABLE', 4.9, 'https://images.unsplash.com/photo-1614283233556-f35b0c801ef1?auto=format&fit=crop&q=80&w=800', 'Navigating complex relationships.', 'r90bbd427f71', 'LMFT-CA-9901', 'MS, Family Therapy', 'CA', 11),
  ('c5', 'Daniel', 'Male', 'Men''s Health', 'AVAILABLE', 4.9, 'https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?auto=format&fit=crop&q=80&w=800', 'Safe space for men.', 'r72f7f7f7c8b', 'LMFT-TX-2201', 'PhD, Psychology', 'TX', 15),
  ('c6', 'Maria', 'Female', 'Women''s Issues', 'AVAILABLE', 5.0, 'https://images.unsplash.com/photo-1607746882042-944635dfe10e?auto=format&fit=crop&q=80&w=800', 'Empowerment and health.', 'r3cb75621574', 'LCSW-NY-1188', 'MSW, Social Work', 'NY', 13),
  ('c7', 'Raj', 'Male', 'Workplace Stress', 'AVAILABLE', 4.9, 'https://images.unsplash.com/photo-1619895862022-09114b41f16f?auto=format&fit=crop&q=80&w=800', 'Burnout prevention strategies.', 'rf8f3aa4b33e', 'PsyD-NY-1102', 'PsyD, Org Psychology', 'NY', 7),
  ('c8', 'Darius', 'Male', 'Addiction Recovery', 'AVAILABLE', 4.9, 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=800', 'One day at a time.', 'r4ba1277e4fb', 'LAC-NJ-8821', 'MA, Addiction Counseling', 'NJ', 14),
  ('c9', 'Danny', 'Male', 'Executive Burnout', 'AVAILABLE', 5.0, 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=800', 'High performance sustainability.', 'r9211b98614f', 'PsyD-CA-9921', 'PsyD, Org Psychology', 'CA', 18),
  ('c10', 'Gabby', 'Female', 'Eating Disorders', 'BUSY', 4.8, 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?auto=format&fit=crop&q=80&w=800', 'Building a healthy relationship with food.', 'r291e545fd67', 'RD-NY-4421', 'MS, Nutrition & Psychology', 'NY', 9),
  ('c11', 'Julia', 'Female', 'Postpartum Support', 'AVAILABLE', 5.0, 'https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?auto=format&fit=crop&q=80&w=800', 'Supporting new mothers.', 'raf6459c9b82', 'LCSW-TX-3321', 'MSW, Clinical Social Work', 'TX', 6),
  ('c12', 'Mary', 'Female', 'Trauma & PTSD', 'AVAILABLE', 4.9, 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=800', 'Healing the past.', 'r378d159c7b0', 'LPC-IL-2210', 'PhD, Clinical Psychology', 'IL', 11),
  ('c13', 'Lucy', 'Female', 'LGBTQ+ Issues', 'AVAILABLE', 5.0, 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&q=80&w=800', 'Affirming and inclusive care.', 'rfc63eab317e', 'LMFT-OR-5521', 'MA, Counseling Psychology', 'OR', 5),
  ('c14', 'Helen', 'Female', 'Anger Management', 'AVAILABLE', 4.7, 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?auto=format&fit=crop&q=80&w=800', 'Constructive expression.', 'rbd2cdb9a3f3', 'LCSW-MA-8812', 'MSW, Social Work', 'MA', 13),
  ('c15', 'Diego', 'Male', 'ADHD Support', 'AVAILABLE', 4.9, 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=800', 'Thriving with neurodiversity.', 'r3a715eeff8d', 'PsyD-MA-6622', 'PsyD, Psychology', 'MA', 10),
  ...
  ('c21', 'Lucas2', 'Male', 'Digital Addiction', 'AVAILABLE', 4.7, 'https://images.unsplash.com/photo-1463453091185-61582044d556?auto=format&fit=crop&q=80&w=800', 'Unplugging for mental health.', 'r92debe21318', 'LCSW-NY-3321', 'MSW, Social Work', 'NY', 6),
