...
const PaymentModal: React.FC<PaymentModalProps> = ({ onClose, onSuccess, initialError }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 dark:bg-black/80 backdrop-blur-md z-[9999] flex items-center justify-center p-4">
            <div className="bg-white/95 dark:bg-black/90 backdrop-blur-3xl rounded-xl w-full max-w-md shadow-sm dark:shadow-sm overflow-hidden animate-in zoom-in duration-300 border border-white/20 dark:border-white/10">
