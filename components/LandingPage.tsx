...
const LandingPage: React.FC<LandingPageProps> = ({ onLoginClick }) => {
    ...
    return (
        <div className={`relative min-h-screen font-sans text-[#0A0A0A] dark:text-[#F3F4F6] selection:bg-yellow-200 selection:text-black transition-colors duration-500 bg-[#fde9a0] dark:bg-[#1C1F26] ${lang === 'ar' ? 'rtl' : 'ltr'}`} dir={lang === 'ar' ? 'rtl' : 'ltr'}>
            ...
            {/* GLOBAL BACKGROUND VIDEO - STICKY TO VIEWPORT TO BYPASS TRANSFORM CONTEXTS */}
            <div className="absolute inset-0 pointer-events-none z-0">
                <div className="sticky top-0 inset-x-0 h-[100vh] overflow-hidden">
                    <video
                        autoPlay
                        loop
                        muted
                    ...
                    <div className="lg:col-span-5 relative mt-10 md:mt-0 perspective-1000">
                        ...
                        >
                            ...
                            >
                                ...
                                {/* Shine effect removed to prevent un-hover glitch */}
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 mb-10 md:mb-12">
                        <div className="md:col-span-5 space-y-4 md:space-y-6">
                            ...
                            <div className="flex gap-5">{[Twitter, Instagram, Linkedin].map((Icon, i) => (<button key={i} className="text-gray-800 dark:text-white hover:text-black dark:hover:text-yellow-400 transition-colors hover:scale-110 transform"><Icon className="w-4 h-4 md:w-5 md:h-5" /></button>))}</div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-1 gap-6 md:col-span-2">
                            <div>
                                ...
                                <ul className="space-y-2 text-xs font-bold text-gray-800 dark:text-white">
                                    ...
                                    <li><Link to="/crisis" className="text-red-600 hover:text-red-400 transition-colors">{t('link_crisis')}</Link></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center text-[9px] font-black uppercase tracking-[0.2em] text-gray-700 dark:text-white gap-4 md:gap-0">
