    ...
    <div className="min-h-screen bg-[#FFFBEB] font-sans text-[#0A0A0A] selection:bg-yellow-200 selection:text-black">
      ...
      <section className="relative pt-48 pb-24 md:pt-64 md:pb-40 px-6 z-10">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-16 items-center">
              <div className="lg:col-span-7 space-y-10 text-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-5 justify-center pt-4">
                      ...
                      <button onClick={() => onLoginClick(true)} className="px-10 py-5 bg-white border border-yellow-200 rounded-full font-black text-lg uppercase tracking-widest hover:bg-yellow-50 transition-all flex items-center justify-center gap-3">
                         View Team
                      </button>
                  </div>

                  <div className="flex items-center justify-center gap-8 pt-10 border-t border-yellow-200/30">
      ...
      <section className="py-24 bg-[#FFFBEB] relative overflow-hidden">
          <div className="max-w-7xl mx-auto text-center mb-16 px-6">
              ...
              <h2 className="text-4xl md:text-5xl font-black leading-[1.1] tracking-tight mb-6">Select Your Guide</h2>
              <button onClick={() => onLoginClick(true)} className="flex items-center gap-3 font-black uppercase tracking-widest text-xs hover:gap-5 transition-all justify-center">
                  Browse Full Roster <ArrowRight className="w-4 h-4 text-[#FACC15]" />
              </button>
          </div>
          ...
          <div className="relative w-full marquee-container">
              <div className="absolute left-0 top-0 bottom-0 w-20 md:w-60 bg-gradient-to-r from-[#FFFBEB] to-transparent z-20 pointer-events-none"></div>
              <div className="absolute right-0 top-0 bottom-0 w-20 md:w-60 bg-gradient-to-l from-[#FFFBEB] to-transparent z-20 pointer-events-none"></div>

              <div className="flex flex-col gap-8">
                  {/* Row 1: Left to Right */}
                  <div className="flex gap-6 animate-marquee w-fit px-4">
                      {[...row1, ...row1, ...row1, ...row1].map((spec, i) => (
                          <div 
                              key={`${spec.id}-1-${i}`}
                              onClick={() => onLoginClick(true)}
                              className="relative flex-shrink-0 w-52 h-72 md:w-64 md:h-80 bg-white rounded-3xl overflow-hidden shadow-lg border border-yellow-100 hover:scale-105 hover:shadow-2xl hover:border-yellow-400 transition-all duration-300 cursor-pointer group"
                          >
                              <div className="h-[80%] w-full relative">
                                  <AvatarImage src={spec.imageUrl} className="w-full h-full object-cover" alt={spec.name} />
                                  <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent"></div>
                              </div>
                              <div className="h-[20%] bg-[#FFFBEB] p-3 flex flex-col justify-center items-center text-center border-t border-yellow-100/50 relative z-10">
                                  <p className="text-xs font-black text-gray-800 uppercase tracking-widest line-clamp-1">{spec.specialty}</p>
                              </div>
                          </div>
                      ))}
                  </div>
                  ...
                  {/* Row 2: Right to Left */}
                  <div className="flex gap-6 animate-marquee-reverse w-fit px-4">
      ...
      <section className="py-20 bg-[#FFFBEB] text-black relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-12 text-center md:text-left relative z-10">
              <div className="flex items-center gap-6">
                  ...
                  <div>
                      ...
                      <p className="text-gray-800 font-medium">End-to-end 256-bit encryption. Your sessions belong to you alone.</p>
                  </div>
              </div>
              <div className="flex gap-12">
                  <div className="text-center">
                      <p className="text-3xl font-black mb-1">99.9%</p>
                      <p className="text-[10px] font-black uppercase tracking-widest text-gray-700">Uptime</p>
                  </div>
                  <div className="text-center">
                      <p className="text-3xl font-black mb-1">0%</p>
                      <p className="text-[10px] font-black uppercase tracking-widest text-gray-700">Data Sharing</p>
                  </div>
                  <div className="text-center">
                      <p className="text-3xl font-black mb-1">AES</p>
                      <p className="text-[10px] font-black uppercase tracking-widest text-gray-700">Encrypted</p>
                  </div>
              </div>
          </div>
      </section>
          ...
          <div className="max-w-xl mx-auto">
              <div className="bg-[#FFFBEB] text-black rounded-[2rem] p-6 text-center relative overflow-hidden shadow-2xl border border-yellow-200">
                  ...
                  <div className="relative z-10 space-y-4">
                      <p className="text-black/60 font-black uppercase tracking-[0.4em] text-[9px]">Premium Access</p>
                      <h2 className="text-2xl font-black tracking-tighter">Pay only for clarity.</h2>
                      
                      <div className="flex flex-col items-center justify-center gap-1 py-1">
                           {settings.saleMode ? (
                               <div className="flex items-baseline gap-2">
                                   <span className="text-lg text-black/50 font-black line-through opacity-50 decoration-black">$1.99</span>
                                   <div className="text-4xl font-black text-black flex items-start gap-1">
                                      <span className="text-lg mt-2">$</span>1.49<span className="text-xs text-black/60 mt-6">/min</span>
                                   </div>
                               </div>
                           ) : (
                               <div className="text-4xl font-black text-black flex items-start gap-1">
                                  <span className="text-lg mt-2">$</span>1.99<span className="text-xs text-black/60 mt-6">/min</span>
                                </div>
                           )}
      ...
      <footer className="bg-[#FFFBEB] text-black py-24 px-6 md:px-10 border-t border-yellow-200 relative z-20">
          <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-20">
                  <div className="md:col-span-5 space-y-8">
                      <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-black rounded-xl flex items-center justify-center">
                              <Heart className="w-6 h-6 fill-[#FACC15] text-[#FACC15]" />
                          </div>
                          <span className="text-2xl font-black tracking-tight">Peutic</span>
                      </div>
                      ...
                      <div className="flex gap-6">
                          {[Twitter, Instagram, Linkedin].map((Icon, i) => (
                              <button key={i} className="text-gray-800 hover:text-black transition-colors hover:scale-110 transform"><Icon className="w-6 h-6"/></button>
                          ))}
                      </div>
                  </div>
                  
                  <div className="md:col-span-2">
                      <h4 className="font-black mb-8 text-[10px] uppercase tracking-[0.3em] text-gray-700">Global</h4>
                  ...
                  <div className="md:col-span-2">
                      <h4 className="font-black mb-8 text-[10px] uppercase tracking-[0.3em] text-gray-700">Support</h4>
                      <ul className="space-y-4 text-sm font-bold text-gray-800">
                  ...
                  <div className="md:col-span-3">
                      <h4 className="font-black mb-8 text-[10px] uppercase tracking-[0.3em] text-gray-700">Regulatory</h4>
                      <ul className="space-y-4 text-sm font-bold text-gray-800">
              ...
              <div className="pt-10 border-t border-black/10 flex flex-col md:flex-row justify-between items-center text-[10px] font-black uppercase tracking-[0.2em] text-gray-700">
