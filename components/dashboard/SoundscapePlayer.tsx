...
export const SoundscapePlayer = React.memo(() => {
    ...
    return (
        <div className={`fixed bottom-20 md:bottom-6 right-4 md:right-6 z-[190] transition-all duration-500 ease-in-out border border-[var(--color-primary-border)] shadow-[0_4px_20px_rgba(0,0,0,0.15)] overflow-hidden backdrop-blur-2xl bg-[var(--color-bg-surface)] ${minimized ? 'w-12 h-12 rounded-full' : 'w-[90vw] max-w-72 rounded-xl p-4'}`}>
