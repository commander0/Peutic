...
export const SoundscapePlayer = React.memo(() => {
    ...
    return (
        <div className={`fixed bottom-24 md:bottom-6 right-4 md:right-6 z-[80] transition-all duration-500 ease-in-out border border-white/20 dark:border-white/10 shadow-2xl overflow-hidden backdrop-blur-md ${minimized ? 'w-12 h-12 rounded-full bg-transparent' : 'w-[90vw] max-w-72 rounded-3xl p-4 bg-transparent'}`}>
