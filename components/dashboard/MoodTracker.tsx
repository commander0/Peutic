...
export const MoodTracker: React.FC<{ onMoodSelect: (m: 'confetti' | 'rain' | null) => void }> = ({ onMoodSelect }) => {
    return (
        <div className="bg-white/20 dark:bg-black/20 backdrop-blur-md p-5 rounded-xl border border-white/20 dark:border-white/5 shadow-glass flex flex-col justify-between">
            <div>
