...
export const JournalSection: React.FC<{ user: User, onUpdate?: () => void }> = ({ user, onUpdate }) => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 h-[450px]">
            <div className="flex flex-col h-full bg-white/50 dark:bg-black/20 backdrop-blur-md rounded-lg p-5 border-0 shadow-sm relative overflow-hidden group">
            ...
            <div className="flex flex-col h-full bg-white/50 dark:bg-black/20 backdrop-blur-xl rounded-lg border-0 shadow-sm overflow-hidden">
