...
export const NotificationBell: React.FC<NotificationBellProps> = ({ notifications, onClear, onClearAll, onAction }) => {
    ...
    return (
        <div className="relative" ref={panelRef}>
            ...
            {isOpen && (
                <div className="fixed inset-x-4 top-16 md:absolute md:top-12 md:left-0 md:right-auto md:w-96 bg-white dark:bg-gray-900 rounded-lg shadow-xl border border-gray-100 dark:border-gray-800 z-50 animate-in slide-in-from-top-2 duration-200 overflow-hidden origin-top-left">
