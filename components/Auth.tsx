...
const Auth: React.FC<AuthProps> = ({ onLogin, onCancel, initialMode = 'login' }) => {
  ...
  if (showOnboarding) {
      return (
        <div className="fixed inset-0 bg-[#FFFBEB] dark:bg-black z-50 flex flex-col md:flex-row animate-in fade-in slide-in-from-bottom-10 duration-500">
            ...
            {/* UPDATED: Added overflow-y-auto and h-full to the container, and min-h-full to inner content to ensure centering but allow scrolling on mobile */}
            <div className="w-full md:w-1/2 h-full overflow-y-auto bg-[#FFFBEB] dark:bg-black text-black dark:text-white">
  ...
  return (
    <div className="fixed inset-0 bg-[#FFFBEB] dark:bg-black z-50 flex flex-col md:flex-row transition-colors">
      ...
      {/* Right Side - UPDATED: Added h-full and overflow-y-auto directly to outer wrapper, and min-h-full to inner */}
      <div className="w-full md:w-1/2 bg-[#FFFBEB] dark:bg-black text-black dark:text-white h-full overflow-y-auto relative">
