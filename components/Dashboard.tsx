  ...
  return (
    <div className="min-h-screen bg-[#FFFBEB] dark:bg-black font-sans text-gray-900 dark:text-gray-100 selection:bg-yellow-200 transition-colors duration-500 relative overflow-hidden flex flex-col">
      ...
      <nav className="bg-[#FFFBEB]/80 dark:bg-black/80 backdrop-blur-xl border-b border-yellow-100 dark:border-gray-800 sticky top-0 z-30 px-4 py-3 md:px-6 md:py-4 flex justify-between items-center shadow-sm transition-colors relative">
          ...
          {/* PANIC BUTTON: Smaller on Mobile, Regular on Desktop */}
          <div className="md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 flex justify-center">
              <button 
                  onClick={() => setShowGrounding(true)} 
                  className="bg-yellow-500 hover:bg-yellow-400 text-black px-3 py-1.5 md:px-6 md:py-2.5 rounded-full font-black text-[10px] md:text-sm uppercase tracking-widest animate-pulse shadow-xl shadow-yellow-500/20 flex items-center gap-2 hover:scale-105 transition-transform"
              >
                  <LifeBuoy className="w-3 h-3 md:w-5 md:h-5" /> Panic Relief
              </button>
          </div>
