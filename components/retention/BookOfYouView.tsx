...
const BookOfYouView: React.FC<BookOfYouViewProps> = ({ user, garden, onClose }) => {
    ...
    const stats = [
        ...
        { label: 'Session Time', value: '420m', icon: Clock },
    ];
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-[#e5e7eb] dark:bg-[#0a0a0a] text-black dark:text-white flex flex-col animate-in fade-in duration-500 overflow-y-auto">
            ...
            <div className="relative h-[300px] md:h-[400px] bg-gradient-to-br from-white via-gray-100 to-gray-300 dark:from-gray-800 dark:via-black dark:to-gray-950 flex flex-col items-center justify-center border-b border-gray-200 dark:border-gray-800 overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="bg-gradient-to-br from-black to-gray-800 text-white p-8 md:p-10 rounded-[3rem] shadow-2xl relative overflow-hidden group">
                        ...
                        <p className="text-gray-300 leading-relaxed text-lg italic mb-8">
                            "You have shown incredible resilience over the last few weeks. Your journals indicate a shift from reactive stress to proactive mindfulness, particularly after your sessions with Dr. Aris. Your presence is becoming more balanced."
                        </p>
                        <div className="flex gap-4">
                            <div className="bg-white/10 px-4 py-2 rounded-full text-xs font-bold">Resilience ↑</div>
                            <div className="bg-white/10 px-4 py-2 rounded-full text-xs font-bold">Focus ↑</div>
                        </div>
                    </div>
