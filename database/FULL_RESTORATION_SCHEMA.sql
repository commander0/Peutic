...
-- ==========================================
-- SOURCE: fix_data_persistence.sql
-- ==========================================
...
-- ==========================================
-- SOURCE: fix_admin_permissions.sql
-- ==========================================
...
-- ==========================================
-- SOURCE: fix_achievements_schema.sql
-- ==========================================
...
-- ==========================================
-- SOURCE: add_dashboard_broadcast.sql
-- ==========================================
...
-- ==========================================
-- SOURCE: 101_strict_rls_users.sql
-- ==========================================
...
-- ==========================================
-- SOURCE: 102_garden_focus_minutes.sql
-- ==========================================
...
values 
    ...
    ('Marcus Rivera', 'Life Coach', 'BUSY', 4.8, 'Specializing in career transitions and motivation.', 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=300', 8, 'ICF'),
    ...
    ('Julia Banks', 'Family Therapist', 'OFFLINE', 4.7, 'Healing relationships and family dynamics.', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=300', 14, 'LMFT'),
    ...
    ('Sophia Rossi', 'Art Therapist', 'BUSY', 4.9, 'Expressing emotion through creative arts.', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=300', 7, 'ATR'),
    ...
    ('Thomas Wright', 'Veterans Support', 'OFFLINE', 4.9, 'PTSD and reintegration specialist.', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=300', 16, 'PsyD'),
    ('Isabella Martinez', 'Eating Disorders', 'BUSY', 4.9, 'Developing healthy relationships with food.', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=300', 12, 'RD'),
    ...
    ('Dr. Samuel Abebe', 'Neurodiversity', 'BUSY', 5.0, 'ADHD and Autism support specialist.', 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=300', 11, 'PhD'),
    ...
    ('Hassan Ahmed', 'Anger Management', 'OFFLINE', 4.7, 'Constructive emotional regulation.', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300', 13, 'PhD'),
    ...
    ('Noah Williams', 'LGBTQ+ Support', 'BUSY', 5.0, 'Affirmative therapy and identity support.', 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=300', 9, 'LCSW'),
    ...
    ('Alexander White', 'Existential Therapy', 'OFFLINE', 4.8, 'Finding purpose and meaning in life.', 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=300', 17, 'PhD'),
    ...
    ('Daniel Anderson', 'Crisis Intervention', 'BUSY', 5.0, 'Immediate support for acute distress.', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300', 15, 'LCSW');


-- ==========================================
-- SOURCE: seed_achievements.sql
-- ==========================================
